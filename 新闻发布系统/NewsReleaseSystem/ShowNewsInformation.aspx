<%@ Page Title="" Language="C#" MasterPageFile="~/mainMaster.Master" AutoEventWireup="true" CodeBehind="ShowNewsInformation.aspx.cs" Inherits="NewsReleaseSystem.ShowNewsInformation" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table style="width:100%">
        <tr style="background-color: #66ccff;">
            <td colspan="2" style="text-align: left; padding-left: 15px;">
                <span>
                    <asp:Label ID="Label4" runat="server" Style="font-weight: 700; color: #FFFFFF; font-size: large;"></asp:Label>
                </span>
            </td>
        </tr>
        <tr>
