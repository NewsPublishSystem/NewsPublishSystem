<%@ Page Title="" Language="C#" MasterPageFile="~/mainMaster.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="NewsReleaseSystem.Default" %>
        ...
        <tr>
                ...
                <table class="dtab1">
                    <tr class="dtr1">
                        <td colspan="2">
                            <b>&nbsp;&nbsp;时事新闻</b>
                            <div class="more ">
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="False" NavigateUrl="~/ShowNewsInformation.aspx?id=1">更多</asp:HyperLink>
                            </div>
                        </td>
                    </tr>
                    <tr>
            ...
            <td class="dtd1">
                <table class="dtab1 ">
                    ...
                    <tr>
                        <td>
                            <asp:DataList ID="dlstEconomic" Height="100" runat="server" BackColor="White" 
                                BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" 
                                GridLines="Both" OnItemCommand="dlstEconomic_ItemCommand">
                                <ItemTemplate>
                                    <table border="0" style="font-size: 9pt; width: 100%; height: 100%;" cellspacing="0"
                                        cellpadding="0">
                                        <tr>
                        ...
                        <td colspan="2">
                            ...
                            <div class="more ">
                                <asp:HyperLink ID="HyperLink3" runat="server" Font-Bold="False" NavigateUrl="~/ShowNewsInformation.aspx?id=4"
                                    Style="text-align: right">更多</asp:HyperLink>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:DataList ID="dlstScience" Height="136" BorderColor="#CCCCCC" BorderStyle="None"
                                BorderWidth="1px" CellPadding="3" GridLines="Both" runat="server"
                                BackColor="White" OnItemCommand="dlstScience_ItemCommand1">
                                <ItemTemplate>
                                    <table border="0" style="font-size: 9pt; width: 100%; height: 100%;" cellspacing="0"
                                        cellpadding="0">
                                        <tr>
                    ...
                    <tr>
                        <td>
                            <asp:DataList ID="dlstMilitary" Height="136" BorderColor="#CCCCCC" BorderStyle="None"
                                BorderWidth="1px" CellPadding="3" GridLines="Both" runat="server" OnItemCommand="dlstMilitary_ItemCommand1"
                                BackColor="White">
                                <ItemTemplate>
                                    <table border="0" style="font-size: 9pt; width: 100%; height: 100%;" cellspacing="0"
                                        cellpadding="0">
                    ...
                    <tr>
                        <td>
                            <asp:DataList ID="dlstSocial" Height="136" BorderColor="#CCCCCC" BorderStyle="None"
                                BorderWidth="1px" CellPadding="3" GridLines="Both" runat="server" OnItemCommand="dlstSocial_ItemCommand1"
                                BackColor="White">
                                <ItemTemplate>
                                    <table border="0" style="font-size: 9pt; width: 100%; height: 100%;" cellspacing="0"
                                        cellpadding="0">
                    ...
                    <tr>
                        <td>
                            <asp:DataList ID="dlstSports" Height="136" BorderColor="#CCCCCC" BorderStyle="None"
                                BorderWidth="1px" CellPadding="3" GridLines="Both" runat="server" OnItemCommand="dlstSports_ItemCommand1"
                                BackColor="White">
                                <ItemTemplate>
                                    <table border="0" style="font-size: 9pt; width: 100%; height: 100%;" cellspacing="0"
                                        cellpadding="0">
                                        <tr>
                                            <td class="dtd2">
                                                <asp:LinkButton runat="server" CommandName="select" CausesValidation="False"><%# DataBinder.Eval(Container.DataItem, "title")%></asp:LinkButton>
                                            </td>
                                            <td style="width: 150px">
                                                <%#DataBinder.Eval(Container.DataItem, "IssueDate")%>
                                            </td>
                    ...
                    <tr>
                        <td>
                            <asp:DataList ID="dlstFun" Height="136" BorderColor="#CCCCCC" BorderStyle="None"
                                BorderWidth="1px" CellPadding="3" GridLines="Both" runat="server" OnItemCommand="dlstFun_ItemCommand1"
                                BackColor="White">
                                <ItemTemplate>
                                    <table border="0" style="font-size: 9pt; width: 100%; height: 100%;" cellspacing="0"
                                        cellpadding="0">
